...
const VARIANTS: Record<string, Variant[]> = {
  L01S01: [
    ...
    { prompt:'Lee: «Practicar deporte con regularidad fortalece el cuerpo, mejora el descanso y ayuda a reducir el estrés». ¿Cuál es la idea principal?', answer:'La actividad física regular aporta beneficios físicos y emocionales', distractors:['El deporte sirve principalmente para dormir','Hacer ejercicio elimina cualquier problema de estrés','Solo mejora los músculos y nada más'], solution:'La idea principal integra los distintos beneficios mencionados sin exagerarlos.' },
  ],
  L02S01: [
    ...
    { prompt:'En «Mis amigos llegaron bastante cansados», ¿qué clase de palabra es «bastante» en este contexto?', answer:'Adverbio', distractors:['Determinante','Sustantivo','Preposición'], solution:'“Bastante” modifica al adjetivo “cansados” indicando grado, por eso funciona como adverbio.' },
  ],
  L03S02: [
    ...
    { prompt:'En «El piloto aterrizó el avión al anochecer», ¿qué significa «piloto»?', answer:'Persona que dirige una aeronave', distractors:['Luz pequeña que indica el funcionamiento de un aparato','Capítulo inicial de una serie','Prueba experimental de un proyecto'], solution:'El verbo “aterrizó” y la referencia al avión determinan el significado profesional de “piloto”.' },
  ],
  L04S01: [
    ...
    { prompt:'¿Qué palabra está correctamente escrita por ser aguda terminada en -n?', answer:'canción', distractors:['cancion','cáncion','cancioń'], solution:'“canción” es aguda, termina en -n y por ello lleva tilde en la sílaba tónica.' },
  ],
  L05S03: [
    ...
    { prompt:'¿Qué fragmento tiene una finalidad principalmente instructiva?', answer:'«Guarda el archivo, cierra el programa y reinicia el equipo.»', distractors:['«El ordenador tiene una carcasa plateada.»','«Ayer el ordenador dejó de funcionar.»','«Los ordenadores procesan información digital.»'], solution:'El fragmento presenta una secuencia de acciones que el lector debe realizar.' },
  ],
  L06S01: [
    ...
    { prompt:'Si un texto presenta un narrador, personajes, un conflicto y una secuencia de acciones, ¿a qué género pertenece principalmente?', answer:'Narrativo', distractors:['Lírico','Dramático','Expositivo'], solution:'La presencia de narrador y acciones organizadas en una historia es característica del género narrativo.' },
  ],
  E01S01: [
