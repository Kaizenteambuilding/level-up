...
export type ProductEvent = 'onboarding_opened' | 'onboarding_avatar_saved' | 'onboarding_mission_opened' | 'onboarding_completed' | 'world_opened' | 'mission_started' | 'mission_completed' | 'client_error'
