...
const TASKS: Record<string, SpanishWritingTask[]> = {
  ...
  L04S04: [
    { id: 'edit-1', skillId: 'L04S04', title: 'Reescritura ortográfica', prompt: 'Reescribe correctamente esta idea con una frase completa: “ayer fuimos de biaje y avia mucha jente”.', hint: 'Corrige viaje, había, gente y la puntuación.', criteria: [{ code: 'words', label: 'Al menos 8 palabras', type: 'min_words', value: 8 }, { code: 'targets', label: 'Corrige viaje, había y gente', type: 'contains_all', values: ['viaje', 'había', 'gente'] }, { code: 'wrong', label: 'Elimina las grafías incorrectas', type: 'forbid', values: ['biaje', 'avia', 'jente'] }, { code: 'punct', label: 'Usa mayúscula inicial y punto', type: 'starts_uppercase' }] },
    ...
    { id: 'edit-3', skillId: 'L04S04', title: 'Puntuación al revisar', prompt: 'Reescribe con puntuación clara: “cuando llegamos al parque vimos patos ardillas y peces después merendamos”.', hint: 'Separa la enumeración y las dos acciones.', criteria: [{ code: 'words', label: 'Al menos 14 palabras', type: 'min_words', value: 14 }, { code: 'comma', label: 'Usa comas', type: 'punctuation', values: [','] }, { code: 'sentences', label: 'Organiza el texto en al menos 2 oraciones', type: 'min_sentences', value: 2 }, { code: 'uppercase', label: 'Empieza con mayúscula', type: 'starts_uppercase' }] },
