-- Version: 20260830072941
-- Canonical repository migration; production applied as 20260830072941.
-- Supersedes the science/geography practice-mode expansions from 20260829081933 and 20260829082924.
...
comment on function public.open_levelup_practice_session(uuid,text) is 'Opens or resumes bounded authenticated district practice for the five active Level Up subjects, limited to one completion per Madrid calendar day.';
