-- Version: 20260827053500
-- Add an authenticated, bounded practice-session opener for the first playable English district.
...
begin
  ...
  if p_mode is distinct from 'english_terminal' then
...
comment on function public.open_levelup_practice_session(uuid,text) is 'Opens or resumes a bounded authenticated practice session. Currently supports the English Terminal district and limits completion to once per Madrid calendar day.';
