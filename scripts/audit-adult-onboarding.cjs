...
const completion = fs.readFileSync('database/migrations/20260824_add_account_onboarding.sql', 'utf8')
const telemetry = fs.readFileSync('database/migrations/20260824_add_privacy_safe_product_events.sql', 'utf8')
