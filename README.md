...
Versión actual: **v1.5.0**. La demo jugable incorpora mapa global, avatar, tienda cosmética, Refugio personalizable y un ciclo completo de Ciudad Matemática: briefing, consola visual de misión, reto académico real, recompensa y regreso al mundo. La economía y personalización de la demo se guardan solo en el navegador y permanecen separadas del XP y los datos pedagógicos.
