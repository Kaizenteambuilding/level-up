...
Versión actual: **v1.6.0**. La demo jugable incorpora mapa global, avatar, tienda cosmética, Refugio personalizable, bitácora de logros y un ciclo completo de Ciudad Matemática: briefing, consola visual de misión, reto académico real, recompensa y regreso al mundo. La economía, personalización y logros de la demo se guardan solo en el navegador y permanecen separados del XP y los datos pedagógicos.
